async function loadDonorsTable() {
  try {
    ...
    console.log('DEBUG - Donors API response:', data); // Add this for debugging

    const tbody = document.getElementById("donorsTableBody");
    tbody.innerHTML = "";

    data.users.forEach(user => {
      // Use user's image if available, otherwise fallback to default
      const userImage = user.userImage || user.user_image || 
      ...
      tr.innerHTML = `
        <td>${user.id}</td>
        <td class="td-img">
          <img class="user-img" src="${userImage}" alt="${user.fullName || user.full_name || 'User'}">
        </td>
...
async function loadRequesterUsers() {
  try {
    ...
    console.log('DEBUG - Requesters API response:', data); // Add this for debugging
...
// Update your banUser function with better debugging
